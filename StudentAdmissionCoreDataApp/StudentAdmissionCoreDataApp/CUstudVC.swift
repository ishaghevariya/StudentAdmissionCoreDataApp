...
class CUstudVC: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        nameTextField.frame = CGRect(x: 30, y: 100, width:view.width - 80, height: 40)
        ageTextField.frame = CGRect(x: 30, y: nameTextField.bottom + 5, width: view.width - 80, height: 40)
        classTextField.frame = CGRect(x: 30, y: ageTextField.bottom + 5, width: view.width - 80, height: 40)
        SaveButton.frame = CGRect(x: 30, y: classTextField.bottom  + 5, width: view.width - 80, height: 40)
