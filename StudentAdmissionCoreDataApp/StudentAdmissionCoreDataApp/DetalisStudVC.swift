...
class DetalisStudVC: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        mybutton.frame = CGRect(x: 40, y: 500, width: 80, height: 40)
...
extension DetalisStudVC : UITableViewDataSource,UITableViewDelegate{
